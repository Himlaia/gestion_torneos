...
class DigitalClock(QLCDNumber):
    ...
    def __init__(self, parent=None):
        ...
        self.setDigitCount(8)  # 8 para formato 24h (HH:MM:SS), se ajusta dinámicamente
    ...
    def is24Hour(self, value):
        ...
        # Ajustar digitCount según el formato
        if self._is24Hour:
            self.setDigitCount(8)  # HH:MM:SS
        else:
            self.setDigitCount(11)  # HH:MM:SS AM
        if self._mode == ClockMode.CLOCK:
            self._updateClock()
